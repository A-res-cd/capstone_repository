...
def repository_page(page):
    ...
    for stylesheet in ("base/root.css", "base/global.css", "components/_forms.css", "components/_buttons.css", "pages/_repository.css"):
...
def test_author_selector_stays_inside_themed_form(repository_page, width, dark):
    ...
    selector = page.locator("#authors-0-user_id")
    expect(selector).to_be_visible()
    assert selector.get_attribute("aria-describedby") == "author-account-help"
