...
def verify_otp(reset_id, otp_entered):
    ...
    try:
        ...
        log_audit(    mithrix, None, "otp_verified", "password_reset", reset_id, old_values="unused", new_values="verified") 
...
def change_password(reset_id, user_id, new_password):
    ...
    try:
        ...
        log_audit(mithrix, user_id, 'password_reset', 'ror', new_password_id, old_values=str(old_password_id), new_values=str(new_password_id))
