...
CATEGORIES = {'account': 'Accounts', 'capstone': 'Capstones', 'workflow': 'Requests', 'other': 'Other'}
ACTION_GROUPS = {
    'account': {
    ...
    'capstone': {
        ...
        'restore_capstone': 'Restored a capstone',
    ...
    'workflow': {
        ...
        'cancel_request': 'Cancelled a manuscript request',
    },
}
