...
pages_module = import_module("app.routes.pages.topics")
...
def client(monkeypatch):
    ...
    monkeypatch.setattr(topics, "get_capstones_corpus", lambda: CORPUS)
...
def test_api_rejects_invalid_inputs_without_querying_archive(client, monkeypatch, payload):
    ...
    monkeypatch.setattr(topics, "get_capstones_corpus", unexpected_query)
    response = client.post("/api/topic-similarity", json=payload)
